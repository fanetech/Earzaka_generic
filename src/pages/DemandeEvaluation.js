...
const DemandeEvaluation = ({ apiLoadingDemandeevaluation, apiDataDemandeevaluation, apiLoadingServices, apiDataServices, getAllDemandedemandeevaluations, getAllServices}) => {
    ...
    return (
        <div className="container-fluid px-4">
            <h1 className="mt-4">Demande d'evaluation</h1>
            <div className="d-flex align-items-center justify-content-between">
                <ol className="breadcrumb mb-4">
                    <li className="breadcrumb-item active">Demande d'evaluation</li>
                </ol>
            </div>
                                                    ...
                                                    <td className="text-end">
                                                        {
                                                            ...
                                                            <Link to={"/ajouter-evaluation/"+data.id} type="button" className="btn btn-sm btn-primary text-white" style={{ color: 'inherit', textDecoration: 'none' }}>Traiter</Link>:""
                                                        }   
                                                    </td>
                                                </tr>
                                            )
...
export default connect(mapStateToProps, mapDispatchToProps)(DemandeEvaluation);
