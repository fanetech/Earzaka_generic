...
const CreateLiquidation = ({ createLiquidation, getAllServices, apiLoadingServices, apiDataServices }) => {
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="d-flex justify-content-center mt-2 p-2">
                                        <Link type="button" className="btn btn-secondary me-1" data-toggle="button" to="/liquidation">Annuler</Link>
                                        {
                                    ...
                                    <div className="d-flex justify-content-center mt-2 p-2">
                                        {
                                            ...
                                            (
                                                <>
                                                    <Link type="button" className="btn btn-secondary me-1" to={"/liquidation"}>Terminer</Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateLiquidation);