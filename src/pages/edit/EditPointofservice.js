...
import { updatePointofservice, getAllPointofservices } from '../../redux/pointofservice/pointofserviceAction';
import methods from '../../constant';
import Swal from 'sweetalert2';

const EditPointofservice = ({ updatePointofservice, apiLoadingPointofservices, apiDataPointofservices, getAllPointofservices }) => {
                                        ...
                                        if (pointofservice.numIFU.length < 2 ) {
                                            ...
                                            if (pointofservice.numCptePS.length < 2 ) {
                                                ...
                                                if (pointofservice.typePS.length < 2 ) {
                                                    ...
                                                    if (updatePointofservice(pointofservice.idPS,pointofservice)) {
                                                        Swal.fire({
...
const mapDispatchToProps = (dispatch) => {
    return {
        updatePointofservice: (id,pointofservice) => dispatch(updatePointofservice(id,pointofservice)),
        getAllPointofservices: ()   => dispatch(getAllPointofservices()),
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(EditPointofservice);