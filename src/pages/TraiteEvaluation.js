...
const TraiteEvaluation = ({ apiLoadingDemandeevaluation, apiDataDemandeevaluation, apiLoadingServices, apiDataServices, getAllDemandedemandeevaluations, getAllServices, createEvaluation}) => {
                        ...
                        <div className="row">
                            <div className="col-sm-12 col-md-12 mb-2">
                                <div className="d-flex justify-content-center mt-2 p-2">
                                    <Link type="button" className="btn btn-secondary me-1" data-toggle="button" to="/effectuerdemandeevaluation">Annuler</Link>
...
export default connect(mapStateToProps, mapDispatchToProps)(TraiteEvaluation);