                                ...
                                <div className="col-sm-12 col-md-12 mb-2 mt-1 styleformule">
                                    ...
                                    </div>
                                    {
                                        ...
                                        <>
                                            ...
                                            {
                                                service.fields.map((data) => (
                                                    <div className="row mb-3 text-center rounded-pill bg-white" key={data.key}>
                                                        ...
                                                        <div className="col-md-3">
                                                            <h6>Libelle en Français : </h6>{data.labels[0]}
                                                        </div>
                                                        <div className="col-md-3">
                                                            <h6>Libelle en Anglais : </h6>{data.labels[1]}
                                                        </div>
                                                    </div>
                                                ))
                                            }
